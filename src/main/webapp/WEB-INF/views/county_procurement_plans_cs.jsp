                                ...
                                <tbody>
                                    <c:forEach var="procurementPlanCs" items="${sessionScope.procurementPlansCs}" varStatus="index">
                                        <tr <c:if test="${index.count % 2 == 0}">class="odd"</c:if>>
                                            ...
                                            <td>${procurementPlanCs.ifadPriorReview.option}</td>
                                            <td>${procurementPlanCs.planVsActual.option}</td>
                                            ...
                                            <td>${procurementPlanCs.approvalByIfad}</td>
                                            <td>${procurementPlanCs.approvalBySda}</td>
                                            <td>${procurementPlanCs.issueReoi}</td>
                                            <td>${procurementPlanCs.receiveBids}</td>
