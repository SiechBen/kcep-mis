                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form">
                            ...
                            <div class="form-group">
                                Description
                                <input id="descrption" class="form-control">
                            </div>
                            <div class="form-group">
                                IFAD prior review
                                <select id="ifad-prior-review" class="form-control">
                                    <c:forEach var="ifadPriorReview" items="${sessionScope.ifadPriorReviewOption}">
                                        <option value="${ifadPriorReview.id}">${ifadPriorReview.option}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="plan-vs-actual" class="form-control">
                                    <c:forEach var="planVsActual" items="${sessionScope.planVsActualOptions}">
                                        <option value="${planVsActual.id}">${planVsActual.option}</option>
                                    </c:forEach>
                                </select> 
                            </div>  
                            <div class="form-group">
                                Cost
                                <input id="cost"  type="number" step="0.01"  class="form-control datefield">
                            </div>
                            <div class="form-group">
                                Procurement method
