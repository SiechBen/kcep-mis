<%-- 
    Document   : login
    Created on : Jun 2, 2016, 6:44:20 AM
    Author     : siech
--%>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="/kcep-mis/ward" method="post" id="login-form">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="E-mail" id="email" type="email" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Password" id="password" type="password" value="" required>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                   ...
                                   <button class="btn btn-lg btn-success btn-block" onclick="loadWindow('/kcep-mis/ward')">Login</button>
                                </fieldset>
                        </div>
                    </div>
                </div>
